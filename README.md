...
- `render_strategy`: dynamic by default. Chooses which render strategy to employ. Two_column works best for novels and storybooks, Html works best for textbooks and Overlay works best for comic books.
