...
export const calculateSpanishScore = (text) => {
  ...
  console.log(`Text: "${text}" - Score: ${score.toFixed(2)} (bigram: ${bigramScore.toFixed(2)}, vowel: ${vowelScore.toFixed(2)}, ending: ${endingScore.toFixed(2)}, special: ${specialCharScore.toFixed(2)})`);
