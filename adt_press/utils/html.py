...
def replace_images(
    html_content: str, image_replacements: dict[ImageID, PlateImage], text_replacements: dict[OutputTextID, PlateText]
) -> str:
...
def replace_texts(html_content: str, text_replacements: dict[OutputTextID, PlateText]) -> str:
    soup = BeautifulSoup(html_content, "html.parser")
