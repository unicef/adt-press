...
def load_json(filepath: str) -> dict:
    """
    Load and return JSON data from a file as a Python dictionary.
    """
...
def _encode_image_to_base64(image_path: str | Path | None) -> str | None:
    if not image_path:
        return None
    try:
        ...
        # You may want to log this in your real code
        return None