...
from models import Image, Page, Metadata, PDFExtract
from utils import write_file, matplotlib_chart, render_drawings
...
Examples:
  ...
  python pdf_extractor.py --pdf_path doc.pdf --start_page 1 --end_page 5 --output_dir ./output
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Ending page number (1-based, 0 means end of document, default: 0)"
    )
